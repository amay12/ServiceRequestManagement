...
body {
    ...
    background: -webkit-linear-gradient(#ff0000, #ffffff); /* For Safari 5.1 to 6.0 */
    background: -o-linear-gradient(#ff0000, #ffffff); /* For Opera 11.1 to 12.0 */
    background: -moz-linear-gradient(#ff0000, #ffffff); /* For Firefox 3.6 to 15 */
    background: linear-gradient(#ff0000, #ffffff); /* Standard syntax (must be last) */
}
</style>
</head>
...
<div id="wrapper">
    ...
    <div id="wrapper">
                            ...
                            <div class="panel-body">
                                <div class="col-lg-4">                       
                                     <h4>Fill these Details:</h4> 
                                        <?php echo form_open('/CACM_Controller/submit_form');?>
                                        <form>
                                        <div class="form-group" >
                                            <div class="form-group">
                                                <label>Client Code:</label>
                                                <?php echo form_error('client_code','<div style="color:#ff1111;" >', '</div>'); ?> 
                                                <input type="text" placeholder="Enter your Company Code" class="form-control" name="client_code">
                                            </div>
                                            <div class="form-group">
                                                <label>Client name:</label><?php echo form_error('client_name','<div style="color:#ff1111;" >', '</div>'); ?> <input type="text" placeholder="Enter your Company Name" class="form-control" name="client_name">
                                            </div>
                                            <div class="form-group">
                                                <label>Client City:</label><?php echo form_error('client_city','<div style="color:#ff1111;" >', '</div>'); ?> <input type="text" placeholder="Enter your Company City" class="form-control" name="client_city">
                                            </div>

                                            <div class="form-group">
                                                <label>Client Contact No.:</label><?php echo form_error('client_mobile','<div style="color:#ff1111;" >', '</div>'); ?> <input type="text" placeholder="Enter your Contact Number" class="form-control" name="client_mobile">
                                            </div>
                                            <div class="form-group">
                                ...
                                <div class="col-lg-8">
                                    ...
                                    <table class="table table-striped table-bordered table-hover">
                                        <tr>
                                            ...
                                            <th>Client Email</th>
                                            <th>Client Time Created</th>
                                            <th>Edit</th>
                                            <th>Delete</th>
                                        </tr>
                                        <?php foreach ($list_all as $key => $value) {  ?>
                                        <tr><td><?php echo $value['client_code'];?></td>
                                            <td><?php echo $value['client_name'];?></td>
                                            <td><?php echo $value['client_city'];?></td>
                                            <td><?php echo $value['client_mobile'];?></td>
                                            <td><?php echo $value['client_email'];?></td>
                                            <td><?php echo $value['client_time'];?></td>
                                            <td><?= anchor("/CACM_Controller/edit/{$value['Sno']}",
                                                'Edit', ['class' => 'btn btn-primary' ])?></td>
                                            <td><?= form_open("/CACM_Controller/delete/{$value['Sno']}");
        ...
        <!-- End of Footer******************************* -->
            </div><!-- container fluid div--> </div> <!-- pagecontent wrapper div--></div><!-- wrapper div--> 
<!-- Page Content End******************************************************************-->
