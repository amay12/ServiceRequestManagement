...
<div id="wrapper">
    ...
    <div id="sidebar-wrapper" class="cat">
        ...
        <ul class="sidebar-nav" id="ulfont">
         <li><a href="<?php echo base_url();?>/index.php/CA_Controller"><blockquote class="blockquote-reverse">
            ...
            <li>Product Technology<span class="pull-right hidden-xs showopacity glyphicon glyphicon-modal-window" id="glyph" ></span></li>
            ...
            <li><a href="<?php echo base_url();?>/index.php/CACat_Controller">Category/Sub-Category<span class="pull-right hidden-xs showopacity glyphicon glyphicon-modal-window" id="glyph" ></a></span></li>
    ...
    <div id="wrapper">      
          ...
          <div id="page-content-wrapper" >
                        ...
                        <h1 class="heading" align="center">Product Technology</h1>
                        ...
                        <div class="col-lg-4"><h4>Enter the Details for <?php echo $companyname; ?>:</h4>
                            <?php echo form_open('/CAProduct_Controller/submit_form');?>
                                  <form>
                                    <div class="form-group" >
                                            <div class="form-group">
                                                <label>Enter a new Product Technology:</label> <input type="text" placeholder="Enter your data" class="form-control" name="product">
                                            </div>
                        ...
                        <div class="col-lg-2"><h4>Entries:</h4>
                            
                         <?php if (!empty( $list_all )) { ?>
                                 <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover">
                                    <tr align= "center">
                                        <th> Technologies available</th>
                                        
                                        
                                    </tr >
                                    <?php foreach ($list_all as $key => $value) {  ?>
                                    <tr align= "center"><td><?php echo $value['product'];?></td>
