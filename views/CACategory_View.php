...
<div id="wrapper">
    ...
    <div id="sidebar-wrapper" class="cat">
        ...
        <ul class="sidebar-nav" id="ulfont">
         <li><a href="<?php echo base_url();?>/index.php/CA_Controller"><blockquote class="blockquote-reverse">
            ...
            <li>Category<span class="pull-right hidden-xs showopacity glyphicon glyphicon-plus-sign" id="glyph" ></span></li>
   ...
   <div id="wrapper">      
          ...
          <div id="page-content-wrapper" >
                        ...
                        <h1 class="heading" align="center">Category</h1>
                        ...
                        <div class="col-lg-4"><h4>Enter the Details:</h4>
                            <?php echo form_open('/CACategory_Controller/submit_form');?>
                                  <form>
                                    <div class="form-group" >
                                            <div class="form-group">
                                                <label>Enter a new Category:</label> <input type="text" placeholder="Enter your data" class="form-control" name="RCat_category">
                                            </div>
