          ...
          <div id="page-content-wrapper" >
                        ...
                        <div class="panel-body">
                            ...
                            <div class="col-lg-4"><h4>Enter the Details:</h4>
                                <?php echo form_open_multipart('<?php echo base_url();?>/index.php/SAU_Controller/submit_form');?>
                                    <form>
                                    <div class="form-group" >
                                        ...
                                        <div class="form-group">
                                            <label>Last Name:</label> <?php echo form_error('lname','<div style="color:#ff1111;" >', '</div>'); ?><input type="text" placeholder="Enter your Last Name" class="form-control" name="lname">
                                        </div>
                                        <div class="form-group">
                                            <label>Email:</label> <?php echo form_error('email','<div style="color:#ff1111;" >', '</div>'); ?><input type="email" placeholder="Enter your Email Address" class="form-control" name="email">
                                        </div>
                                        <div class="form-group">
                                            <label>Enter a password:</label><?php echo form_error('password','<div style="color:#ff1111;" >', '</div>'); ?> <input type="password" placeholder="Minimum 6 characters" class="form-control" name="password">
                                        </div>
                                        <div class="form-group">
                                            <label>Re-enter the password:</label> <?php echo form_error('reenter','<div style="color:#ff1111;" >', '</div>'); ?><input type="password" placeholder="Re-enter Password" class="form-control" name="reenter">
                                        </div>
                                        <div class="form-group">
                                            <label>Phone Number:</label> <?php echo form_error('mobile','<div style="color:#ff1111;" >', '</div>'); ?><input type="text" placeholder="Enter your Phone Number" class="form-control" name="mobile">
                                        </div>
                                       <!-- <div class="form-group" >
                              ...
                              <?php if (!empty( $list_all )) { ?>
                                ...
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <tr><td><?php echo $value['fname'];?></td>
                                        ...
                                        <td><?= anchor("/SAU_Controller/edit/{$value['id']}",
                                            'Edit', ['class' => 'btn btn-primary' ])?></td>
                                        <td>
                                            <?= form_open("/SAU_Controller/delete/{$value['id']}");
