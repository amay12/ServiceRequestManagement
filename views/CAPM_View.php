<?php echo form_error('company_code','<div style="color:#ff1111;" >', '</div>'); ?><!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="mainNavBar">
            ...
            <ul class="nav navbar-nav navbar-right">
                <li><a href="<?php echo base_url();?>/index.php/CAPM_Controller/logout"><b><?php echo $fname;?> | Logout <span class="glyphicon glyphicon-log-out"></b></span></a></li>
            </ul>
...
<div id="wrapper">
    ...
    <div id="sidebar-wrapper" class="cat">
        ...
        <ul class="sidebar-nav" id="ulfont">
         <li><a href="<?php echo base_url();?>/index.php/CA_Controller"><blockquote class="blockquote-reverse">
            ...
            <li>Product Master<span class="pull-right hidden-xs showopacity glyphicon glyphicon-list-alt" id="glyph" ></span></li>
   ...
   <div id="wrapper">      
          ...
          <div id="page-content-wrapper" >
                        ...
                        <h1 class="heading" align="center"> Product Master</h1>
                        ...
                        <div class="panel-body">
                            ...
                            <div class="col-lg-6">                        <h4>Fill these Details:</h4> 
                            <?php echo form_open('/CAPM_Controller/submit_form');?>
                                <form>
                                    <div class="form-group" >
                                    <div class="form-group">
                                            <label>Product Code:</label> <?php echo form_error('capm_code','<div style="color:#ff1111;" >', '</div>'); ?><input name="capm_code" type="text" placeholder="Enter your Product Code" class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <label>Product Name:</label> <?php echo form_error('capm_name','<div style="color:#ff1111;" >', '</div>'); ?><input name="capm_name" type="text" placeholder="Enter your Product Name" class="form-control">
                                        </div>
                                        
                                        <div class="form-group"> <label>Product Technology</label> <select name="capm_tech" class="form-control">
                                             <?php foreach ($list_product as $key => $value) {  ?>
                                                    <option name="product"><?php echo $value['product'];?></option>
                                                    <?php } ?>
                                        </select>
                                        <label>OR Create a New Technology<a href="<?php echo base_url();?>/index.php/CAProduct_Controller"> Here</a></label><hr/>
                                        </div>
                                        <div class="form-group">
                                            <label>Product Description:</label> <?php echo form_error('capm_desc','<div style="color:#ff1111;" >', '</div>'); ?><input type="text" name="capm_desc" placeholder="Enter your Product Description" class="form-control">
                                        </div>
                                         <div >
                                            <button type="submit" class="btn btn-success btn-sm">Submit</button>
                                            <input type="reset" class="btn btn-primary btn-sm" value="Reset"></button>
                                        </div>

                                    </div></form></div>
                                     <div class="col-lg-6">                        <h4>Entries:</h4> 
                              ...
                              <?php if (!empty( $list_all )) { ?>
                                ...
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <tr><td><?php echo $value['capm_code'];?></td>
                                        <td><?php echo $value['capm_name'];?></td>
                                        <td><?php echo $value['capm_tech'];?></td>
                                        <td><?php echo $value['capm_desc'];?></td>
                                        <td><?= anchor("/CAPM_Controller/edit/{$value['Sno']}",
                                            'Edit', ['class' => 'btn btn-primary btn-sm' ])?></td>
                                        <td>
                                            <?= 
                                                form_open("/CAPM_Controller/delete/{$value['Sno']}");
