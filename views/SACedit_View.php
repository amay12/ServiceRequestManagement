    ...
    <div id="wrapper">      
          ...
          <div id="page-content-wrapper" >
                        ...
                        <h4 class="heading">Edit Your Details:</h4>
                            <div class="col-lg-6">
                                <?php echo form_open("/SAC_Controller/update/{$var->Sno}"); ?>
                                  <form>
                                    <div class="form-group" >
                                            <div class="form-group">
                                                ...
                                                value=<?php echo $var->company_code; ?> >
                                            </div>
                                            <div class="form-group">
                                                ...
                                                value=<?php echo $var->company_name; ?> >
                                            </div>
                                            <div class="form-group">
                                                ...
                                                value=<?php echo $var->company_city; ?> >
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                value=<?php echo $var->company_mobile; ?> >
                                            </div>
                                            <div class="form-group">
                                                ...
                                                value=<?php echo $var->company_email; ?> >
                                            </div>
