    ...
    <div id="wrapper">      
          ...
          <div id="page-content-wrapper" >
                        ...
                        <div class="panel-body">
                            ...
                            <div class="col-lg-6">
                            <?php echo form_open("/CAPM_Controller/update/{$var->Sno}");?>
                                <form>
                                    <div class="form-group" >
                                    <div class="form-group">
                                            <label>Product Code:</label> <?php echo form_error('capm_code','<div style="color:#ff1111;" >', '</div>'); ?><input name="capm_code" type="text" placeholder="Enter your Product Code" class="form-control" value=<?php echo $var->capm_code; ?>>
                                        </div>
                                        <div class="form-group">
                                            <label>Product Name:</label> <?php echo form_error('capm_name','<div style="color:#ff1111;" >', '</div>'); ?><input name="capm_name" type="text" placeholder="Enter your Product Name" class="form-control" value=<?php echo $var->capm_name; ?>>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <label>Product Description:</label> <?php echo form_error('capm_desc','<div style="color:#ff1111;" >', '</div>'); ?><input type="text" name="capm_desc" placeholder="Enter your Product Description" class="form-control" value=<?php echo $var->capm_desc; ?>>
                                        </div>
                                         <div >
