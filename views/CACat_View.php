...
<head>
    <meta charset="UTF-8">
    <title>Request Category/ Sub-Category</title>
    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="mainNavBar">
            ...
            <ul class="nav navbar-nav navbar-right">
                <li><a href="<?php echo base_url();?>/index.php/CACat_Controller/logout"><b><?php echo $fname;?> | Logout <span class="glyphicon glyphicon-log-out"></b></span></a></li>
            </ul>
...
<div id="wrapper">
        ...
        <ul class="sidebar-nav" id="ulfont">
         <li><a href="<?php echo base_url();?>/index.php/CA_Controller"><blockquote class="blockquote-reverse">
            ...
            <li><a href="<?php echo base_url();?>/index.php/CACP_Controller">Client-Product Link<span class="pull-right hidden-xs showopacity glyphicon glyphicon-transfer" id="glyph" ></span></a></li>
             <li><a href="<?php echo base_url();?>/index.php/CACategory_Controller">Category<span class="pull-right hidden-xs showopacity glyphicon glyphicon-plus-sign" id="glyph" ></a></span></li>
            <li>Category/Sub-Category<span class="pull-right hidden-xs showopacity glyphicon glyphicon-modal-window" id="glyph" ></span></li>
   ...
   <div id="wrapper">      
          ...
          <div id="page-content-wrapper" >
                        ...
                        <h1 class="heading" align="center"> Request Category/ Sub-Category</h1>
                        ...
                        <div class="col-lg-4"><h4>Enter the Details:</h4>
                            <?php echo form_open('/CACat_Controller/submit_form');?>
                                  <form>
                                    <div class="form-group" >
                                             <div class="form-group">  <label>Select Category:</label><select class="form-control" name="RCat_category">
                                                    <?php foreach ($list_category as $key => $value) {  ?>
                                                    <option name="RCat_category"><?php echo $value['category'];?></option>
                                                    <?php } ?>
                                                    </select><br>
                                                   <label> OR
                                                    Create a <?= anchor("/CACategory_Controller",
                                            'New Category', ['class' => 'btn btn-primary btn-sm' ])?> </label>
                                                </div><hr>
                                            <div class="form-group">
                                                <label>Enter a new Sub-Category:</label> <input type="text" placeholder="Enter a Sub Category" class="form-control" name="RCat_subcategory">
                                            </div>
                        ...
                        <div class="col-lg-4"><h4>Entries:</h4>
                         ...
                         <?php if (!empty( $list_all )) { ?>
                                ...
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <tr><td><?php echo $value['RCat_category'];?></td>
...
</html><?php echo base_url();?>/assets/sidebar.css
<?php echo base_url();?>/assets/footer.css