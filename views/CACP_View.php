...
<div id="wrapper">
    ...
    <div id="sidebar-wrapper" class="cat">
        ...
        <ul class="sidebar-nav" id="ulfont">
         <li><a href="<?php echo base_url();?>/index.php/CA_Controller"><blockquote class="blockquote-reverse">
            ...
            <li>Client-Product Link<span class="pull-right hidden-xs showopacity glyphicon glyphicon-transfer" id="glyph" ></span></li>
   ...
   <div id="wrapper">      
          ...
          <div id="page-content-wrapper" >
                        ...
                        <h1 class="heading" align="center"> Client - Product Link</h1>

                        <div class="text-info"><p id="demo" align="right"></p>
                            <script>
                                document.getElementById("demo").innerHTML = Date();
                            </script>
                        </div><?php echo form_open("/CACP_Controller/newt")?>
                        <div class="col-lg-5">
                                <h4 class="heading">Clients in <?php echo $companyname;?></h4>
                               <?php if (!empty( $CAC )) { ?>
                         ...
                         <?php if (!empty( $CAP )) { ?>
                                ...
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <tr><td><?php echo $value['capm_code'];?></td>
                                        ...
                                        <td><input type="radio" name="radio2" value=<?php echo $value['Sno'] ?>>
                                        </td>
                    ...
                    <input type="submit" class="btn btn-success" ></button></form>
                   </div>
                     <div class="col-lg-12" align="center">
                              ...
                              <?php if (!empty( $list_all )) { ?>
                                ...
                                <h4>Entries:</h4> 
                                 <div class="table-responsive">
                                    ...
                                    <tr align="center"><td><?php echo $value['CACM'];?></td>
                                        <td><?php echo $value['CAPM'];?></td>
